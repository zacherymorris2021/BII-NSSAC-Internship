...
int main(int argc, char * argv[]) {
    ...
    cout << "-------------" << endl;
    cout << "orginial PIDs before rewire" << endl;
    cout << "source: ";
    for(auto it = sourcePIDs.begin(); it != sourcePIDs.end(); it++) {
        cout << *it << " ";
    }
    cout << endl;
    cout << "target: ";
    for(auto it2 = targetPIDs.begin(); it2 != targetPIDs.end(); it2++) {
        cout  << *it2 << " ";
    }
    cout << endl;
    ...
    cout << "-------------" << endl;
    cout << "copy PIDs before rewire" << endl;
    cout << "source: ";
    for(auto it = sourceCopies.begin(); it != sourceCopies.end(); it++) {
        cout << *it << " ";
    }
    cout << endl;
    cout << "target: ";
    for(auto it2 = targetCopies.begin(); it2 != targetCopies.end(); it2++) {
        cout  << *it2 << " ";
    }
    cout << endl;

    cout << "-------------" << endl;
    cout << "random IDs generated" << endl;
    cout << "original random IDs: ";
    for(auto it = originalRandomIDs.begin(); it != originalRandomIDs.end(); it++) {
        cout << *it << " ";
    }
    cout << endl;
    cout << "copy random IDs: ";
    for(auto it2 = copyRandomIDs.begin(); it2 != copyRandomIDs.end(); it2++) {
        cout  << *it2 << " ";
    }
    cout << endl;
    ...
    cout << "-------------" << endl;
    cout << "orginial PIDs after rewire" << endl;
    cout << "source: ";
    for(auto it = sourcePIDs.begin(); it != sourcePIDs.end(); it++) {
        cout << *it << " ";
    }
    ...
    cout << "-------------" << endl;
    cout << "copy PIDs after rewire" << endl;
    cout << "source: ";
    for(auto it = sourceCopies.begin(); it != sourceCopies.end(); it++) {
        cout << *it << " ";
    }
